...
window.MF_I18N = {
  ...
  // ── Media Library (feat/media-library Fase A) ─────
  'media.title':        {it: 'Media Library',    en: 'Media Library',    fr: 'Médiathèque',       de: 'Media Library',      es: 'Biblioteca Media'},
  'media.introTitle':   {it: 'Media Library',    en: 'Media Library',    fr: 'Médiathèque',       de: 'Media Library',      es: 'Biblioteca Media'},
  'media.introBody':    {it: '— browser unificato di asset digitali (file) e fisici (LTO, HDD, DCP). Sola lettura: filtra, seleziona, ispeziona.', en: '— unified browser of digital (files) and physical (LTO, HDD, DCP) assets. Read-only: filter, select, inspect.', fr: '— navigateur unifié des actifs numériques (fichiers) et physiques (LTO, HDD, DCP). Lecture seule : filtrer, sélectionner, inspecter.', de: '— einheitlicher Browser für digitale (Dateien) und physische (LTO, HDD, DCP) Assets. Schreibgeschützt: filtern, auswählen, prüfen.', es: '— navegador unificado de activos digitales (archivos) y físicos (LTO, HDD, DCP). Solo lectura: filtrar, seleccionar, inspeccionar.'},
  'media.search':       {it: 'Nome · path · serial', en: 'Name · path · serial', fr: 'Nom · chemin · série', de: 'Name · Pfad · Seriennr.', es: 'Nombre · ruta · serie'},
  'media.all':          {it: 'Tutte',            en: 'All',              fr: 'Toutes',            de: 'Alle',               es: 'Todas'},
  'media.nature':       {it: 'Natura',           en: 'Nature',           fr: 'Nature',            de: 'Art',                es: 'Naturaleza'},
  'media.digital':      {it: 'Digitale',         en: 'Digital',          fr: 'Numérique',         de: 'Digital',            es: 'Digital'},
  'media.physical':     {it: 'Fisico',           en: 'Physical',         fr: 'Physique',          de: 'Physisch',           es: 'Físico'},
  'media.type':         {it: 'Tipo',             en: 'Type',             fr: 'Type',              de: 'Typ',                es: 'Tipo'},
  'media.status':       {it: 'Stato',            en: 'Status',           fr: 'État',              de: 'Status',             es: 'Estado'},
  'media.storage':      {it: 'Storage',          en: 'Storage',          fr: 'Stockage',          de: 'Speicher',           es: 'Almacenamiento'},
  'media.checksum':     {it: 'Checksum',         en: 'Checksum',         fr: 'Somme de contrôle', de: 'Prüfsumme',          es: 'Suma de verificación'},
  'media.size':         {it: 'Dimensione',       en: 'Size',             fr: 'Taille',            de: 'Größe',              es: 'Tamaño'},
  'media.colName':      {it: 'Nome',             en: 'Name',             fr: 'Nom',               de: 'Name',               es: 'Nombre'},
  'media.colProject':   {it: 'Progetto · Cliente', en: 'Project · Client', fr: 'Projet · Client', de: 'Projekt · Kunde',    es: 'Proyecto · Cliente'},
  'media.detail':       {it: 'Dettaglio',        en: 'Detail',           fr: 'Détail',            de: 'Details',            es: 'Detalle'},
  'media.tech':         {it: 'Specifiche tecniche', en: 'Tech specs',    fr: 'Spécifications',    de: 'Tech-Spezifikationen', es: 'Especificaciones'},
  'media.deliverables': {it: 'Consegne collegate', en: 'Linked deliverables', fr: 'Livrables liés', de: 'Verknüpfte Lieferungen', es: 'Entregables vinculados'},
  'media.linkedDelivery': {it: 'Consegna',       en: 'Delivery',         fr: 'Livraison',         de: 'Lieferung',          es: 'Entrega'},
  'media.showProposals': {it: 'Mostra proposte agent', en: 'Show agent proposals', fr: 'Afficher propositions agent', de: 'Agent-Vorschläge anzeigen', es: 'Mostrar propuestas del agente'},
  'media.selected':     {it: '{n} selezionati', en: '{n} selected',     fr: '{n} sélectionnés',  de: '{n} ausgewählt',     es: '{n} seleccionados'},
  'media.items':        {it: 'elementi',         en: 'items',            fr: 'éléments',          de: 'Elemente',           es: 'elementos'},
  'media.loadMore':     {it: 'Carica altro',     en: 'Load more',        fr: 'Charger plus',      de: 'Mehr laden',         es: 'Cargar más'},
  'media.empty':        {it: 'Nessun asset trovato con questi filtri.', en: 'No assets found with these filters.', fr: 'Aucun actif trouvé avec ces filtres.', de: 'Keine Assets mit diesen Filtern gefunden.', es: 'No se encontraron activos con estos filtros.'},
  'media.reset':        {it: 'Azzera',           en: 'Reset',            fr: 'Réinitialiser',     de: 'Zurücksetzen',       es: 'Restablecer'},
  'media.loadError':    {it: 'Errore nel caricamento', en: 'Load error',  fr: 'Erreur de chargement', de: 'Ladefehler',       es: 'Error de carga'},
  'media.bulkSoon':     {it: 'Disponibile a breve', en: 'Coming soon',   fr: 'Bientôt disponible', de: 'Demnächst verfügbar', es: 'Próximamente'},
  'media.bulkAssociate': {it: 'Associa a consegna', en: 'Link to delivery', fr: 'Lier à livraison', de: 'Mit Lieferung verknüpfen', es: 'Vincular a entrega'},
  'media.bulkArchive':  {it: 'Archivia',         en: 'Archive',          fr: 'Archiver',          de: 'Archivieren',        es: 'Archivar'},
  'media.bulkExport':   {it: 'Esporta',          en: 'Export',           fr: 'Exporter',          de: 'Exportieren',        es: 'Exportar'},
  'media.linkedYes':    {it: 'Linkato',          en: 'Linked',           fr: 'Lié',               de: 'Verknüpft',          es: 'Vinculado'},
  'media.linkedNo':     {it: 'Non linkato',      en: 'Not linked',       fr: 'Non lié',           de: 'Nicht verknüpft',    es: 'No vinculado'},
  'media.fltNature':    {it: 'Natura',           en: 'Nature',           fr: 'Nature',            de: 'Art',                es: 'Naturaleza'},
  'media.fltProject':   {it: 'Progetto',         en: 'Project',          fr: 'Projet',            de: 'Projekt',            es: 'Proyecto'},
  'media.fltClient':    {it: 'Cliente',          en: 'Client',           fr: 'Client',            de: 'Kunde',              es: 'Cliente'},
  'media.fltDepartment': {it: 'Reparto',         en: 'Department',       fr: 'Département',        de: 'Abteilung',          es: 'Departamento'},
  'media.fltAssetType': {it: 'Tipo (digitale)',  en: 'Type (digital)',   fr: 'Type (numérique)',  de: 'Typ (digital)',      es: 'Tipo (digital)'},
  'media.fltPhysicalKind': {it: 'Tipo (fisico)', en: 'Type (physical)',  fr: 'Type (physique)',   de: 'Typ (physisch)',     es: 'Tipo (físico)'},
  'media.fltDeliveryStatus': {it: 'Stato consegna', en: 'Delivery status', fr: 'État livraison', de: 'Lieferstatus',       es: 'Estado de entrega'},
  'media.fltLinked':    {it: 'Consegna',         en: 'Delivery',         fr: 'Livraison',         de: 'Lieferung',          es: 'Entrega'},
  'media.fltResolution': {it: 'Risoluzione',     en: 'Resolution',       fr: 'Résolution',        de: 'Auflösung',          es: 'Resolución'},
  'media.fltCodec':     {it: 'Codec',            en: 'Codec',            fr: 'Codec',             de: 'Codec',              es: 'Códec'},
  'media.fltArchive':   {it: 'Solo archivio interno', en: 'Internal archive only', fr: 'Archive interne uniquement', de: 'Nur internes Archiv', es: 'Solo archivo interno'},
  'media.fltDelivered': {it: 'Solo consegnati',  en: 'Delivered only',   fr: 'Livrés uniquement', de: 'Nur ausgeliefert',   es: 'Solo entregados'},
  ...
  'media.archiveBtn':   {it: 'Archivia',         en: 'Archive',          fr: 'Archiver',          de: 'Archivieren',        es: 'Archivar'},
  'media.unarchiveBtn': {it: 'Smarca archivio',  en: 'Unarchive',        fr: 'Désarchiver',       de: 'Aus Archiv entfernen', es: 'Desarchivar'},
  'media.unlinkBtn':    {it: 'Scollega',         en: 'Unlink',           fr: 'Dissocier',         de: 'Trennen',            es: 'Desvincular'},
  'media.exportBtn':    {it: 'Esporta CSV',      en: 'Export CSV',       fr: 'Exporter CSV',      de: 'CSV exportieren',    es: 'Exportar CSV'},
  'media.assocTitle':   {it: 'Associa a consegna', en: 'Link to delivery', fr: 'Lier à livraison', de: 'Mit Lieferung verknüpfen', es: 'Vincular a entrega'},
  'media.unlinkTitle':  {it: 'Scollega da consegna', en: 'Unlink from delivery', fr: 'Dissocier de la livraison', de: 'Von Lieferung trennen', es: 'Desvincular de entrega'},
  'media.assocSearch':  {it: 'Cerca consegna',   en: 'Search delivery',  fr: 'Rechercher livraison', de: 'Lieferung suchen',  es: 'Buscar entrega'},
  'media.assocDeliverable': {it: 'Consegna',     en: 'Delivery',         fr: 'Livraison',         de: 'Lieferung',          es: 'Entrega'},
  'media.reason':       {it: 'Motivo (opzionale)', en: 'Reason (optional)', fr: 'Motif (facultatif)', de: 'Grund (optional)', es: 'Motivo (opcional)'},
  'media.reasonPh':     {it: 'Es. QC negativo, ri-consegna', en: 'E.g. QC failed, redelivery', fr: 'Ex. QC échoué, relivraison', de: 'z.B. QC negativ, Neulieferung', es: 'Ej. QC fallido, reentrega'},
  'media.supersedeWarn': {it: 'Se la consegna ha già un asset attivo della stessa natura, verrà superseduto (storico mantenuto).', en: 'If the delivery already has an active asset of the same nature, it will be superseded (history kept).', fr: "Si la livraison a déjà un asset actif de même nature, il sera remplacé (historique conservé).", de: 'Hat die Lieferung bereits ein aktives Asset gleicher Art, wird es ersetzt (Historie bleibt erhalten).', es: 'Si la entrega ya tiene un asset activo de la misma naturaleza, será reemplazado (se conserva el historial).'},
  'media.cancel':       {it: 'Annulla',          en: 'Cancel',           fr: 'Annuler',           de: 'Abbrechen',          es: 'Cancelar'},
  'media.confirm':      {it: 'Conferma',         en: 'Confirm',          fr: 'Confirmer',         de: 'Bestätigen',         es: 'Confirmar'},
  'media.selectFirst':  {it: 'Seleziona prima almeno un asset', en: 'Select at least one asset first', fr: "Sélectionnez d'abord au moins un asset", de: 'Zuerst mindestens ein Asset auswählen', es: 'Selecciona primero al menos un asset'},
  'media.pickDeliverable': {it: 'Scegli una consegna', en: 'Pick a delivery', fr: 'Choisissez une livraison', de: 'Lieferung auswählen', es: 'Elige una entrega'},
  'media.assocDone':    {it: '{n} associati, {s} superseduti', en: '{n} linked, {s} superseded', fr: '{n} liés, {s} remplacés', de: '{n} verknüpft, {s} ersetzt', es: '{n} vinculados, {s} reemplazados'},
  'media.unlinkDone':   {it: '{n} scollegati',   en: '{n} unlinked',     fr: '{n} dissociés',     de: '{n} getrennt',       es: '{n} desvinculados'},
  'media.flagsDone':    {it: '{n} aggiornati',   en: '{n} updated',      fr: '{n} mis à jour',    de: '{n} aktualisiert',   es: '{n} actualizados'},
  'media.actionError':  {it: 'Azione fallita',   en: 'Action failed',    fr: 'Action échouée',    de: 'Aktion fehlgeschlagen', es: 'Acción fallida'},
  ...
  'settings.account.mailFull':             {it: 'Attiva gestione avanzata mail', en: 'Enable advanced mail management', fr: 'Activer la gestion avancée email', de: 'Erweiterte Mail-Verwaltung aktivieren', es: 'Activar gestión avanzada de correo'},
  'settings.account.mailFullActive':       {it: 'Gestione avanzata mail ✓', en: 'Advanced mail management ✓', fr: 'Gestion avancée email ✓', de: 'Erweiterte Mail-Verwaltung ✓', es: 'Gestión avanzada de correo ✓'},
  ...
  'cal.event.attendees': {it: 'Partecipanti', en: 'Attendees', fr: 'Participants', de: 'Teilnehmer', es: 'Participantes'},
  'cal.event.attendeesHint': {it: 'email, separate da virgola', en: 'emails, comma-separated', fr: 'e-mails, separes par virgule', de: 'E-Mails, kommagetrennt', es: 'correos, separados por comas'},
  'cal.event.description': {it: 'Descrizione', en: 'Description', fr: 'Description', de: 'Beschreibung', es: 'Descripcion'},
  ...
  'mail.star':         {it: 'Speciale', en: 'Starred', fr: 'Suivi', de: 'Markiert', es: 'Destacado'},
  'mail.markRead':     {it: 'Segna letto', en: 'Mark read', fr: 'Marquer lu', de: 'Als gelesen', es: 'Marcar leido'},
  'mail.markUnread':   {it: 'Segna non letto', en: 'Mark unread', fr: 'Marquer non lu', de: 'Als ungelesen', es: 'Marcar no leido'},
  'mail.archive':      {it: 'Archivia', en: 'Archive', fr: 'Archiver', de: 'Archivieren', es: 'Archivar'},
  'mail.trash':        {it: 'Cestino', en: 'Trash', fr: 'Corbeille', de: 'Papierkorb', es: 'Papelera'},
  'mail.moveTo':       {it: 'Sposta in…', en: 'Move to…', fr: 'Déplacer vers…', de: 'Verschieben nach…', es: 'Mover a…'},
  'mail.selected':     {it: '{n} selezionati', en: '{n} selected', fr: '{n} sélectionnés', de: '{n} ausgewählt', es: '{n} seleccionados'},
  'mail.spam':         {it: 'Segna come spam', en: 'Mark as spam', fr: 'Marquer comme spam', de: 'Als Spam markieren', es: 'Marcar como spam'},
  'mail.moveToLabel':  {it: 'Sposta in etichetta', en: 'Move to label', fr: 'Déplacer vers le libellé', de: 'In Label verschieben', es: 'Mover a etiqueta'},
  'mail.deleteForever': {it: 'Elimina definitivamente', en: 'Delete forever', fr: 'Supprimer définitivement', de: 'Endgültig löschen', es: 'Eliminar definitivamente'},
  'mail.emptyTrash':   {it: 'Svuota cestino', en: 'Empty trash', fr: 'Vider la corbeille', de: 'Papierkorb leeren', es: 'Vaciar papelera'},
  'mail.needMailFull': {it: 'Attiva gestione avanzata in Impostazioni', en: 'Enable advanced management in Settings', fr: "Activer la gestion avancée dans les Paramètres", de: 'Erweiterte Verwaltung in Einstellungen aktivieren', es: 'Activar gestión avanzada en Ajustes'},
  'mail.confirmDeleteForever': {it: 'Eliminare definitivamente {n} email? Operazione irreversibile.', en: 'Permanently delete {n} email(s)? This cannot be undone.', fr: 'Supprimer définitivement {n} e-mail(s) ? Action irréversible.', de: '{n} E-Mail(s) endgültig löschen? Nicht rückgängig zu machen.', es: '¿Eliminar definitivamente {n} correo(s)? Acción irreversible.'},
  'mail.confirmEmptyTrash': {it: 'Svuotare il cestino definitivamente? Operazione irreversibile.', en: 'Empty the trash permanently? This cannot be undone.', fr: 'Vider la corbeille définitivement ? Action irréversible.', de: 'Papierkorb endgültig leeren? Nicht rückgängig zu machen.', es: '¿Vaciar la papelera definitivamente? Acción irreversible.'},
  'mail.selectAll':    {it: 'Seleziona tutto', en: 'Select all', fr: 'Tout sélectionner', de: 'Alles auswählen', es: 'Seleccionar todo'},
  'mail.loadMore':     {it: 'Carica altro', en: 'Load more', fr: 'Charger plus', de: 'Mehr laden', es: 'Cargar más'},
  'mail.actionOk':     {it: 'Fatto', en: 'Done', fr: 'Fait', de: 'Erledigt', es: 'Hecho'},
  'mail.actionPartial': {it: 'Alcune azioni non riuscite', en: 'Some actions failed', fr: 'Certaines actions ont échoué', de: 'Einige Aktionen fehlgeschlagen', es: 'Algunas acciones fallaron'},
  ...
  'mail.remove':       {it: 'Rimuovi', en: 'Remove', fr: 'Retirer', de: 'Entfernen', es: 'Quitar'},
  'mail.save':         {it: 'Salva', en: 'Save', fr: 'Enregistrer', de: 'Speichern', es: 'Guardar'},
  'mail.cancel':       {it: 'Annulla', en: 'Cancel', fr: 'Annuler', de: 'Abbrechen', es: 'Cancelar'},
  'mail.tbFont':       {it: 'Font', en: 'Font', fr: 'Police', de: 'Schriftart', es: 'Fuente'},
  'mail.tbSize':       {it: 'Dimensione', en: 'Size', fr: 'Taille', de: 'Größe', es: 'Tamaño'},
  'mail.tbBold':       {it: 'Grassetto', en: 'Bold', fr: 'Gras', de: 'Fett', es: 'Negrita'},
  'mail.tbItalic':     {it: 'Corsivo', en: 'Italic', fr: 'Italique', de: 'Kursiv', es: 'Cursiva'},
  'mail.tbUnderline':  {it: 'Sottolineato', en: 'Underline', fr: 'Souligné', de: 'Unterstrichen', es: 'Subrayado'},
  'mail.tbColor':      {it: 'Colore testo', en: 'Text color', fr: 'Couleur du texte', de: 'Textfarbe', es: 'Color de texto'},
  'mail.tbBullets':    {it: 'Elenco puntato', en: 'Bulleted list', fr: 'Liste à puces', de: 'Aufzählung', es: 'Lista con viñetas'},
  'mail.tbNumbers':    {it: 'Elenco numerato', en: 'Numbered list', fr: 'Liste numérotée', de: 'Nummerierte Liste', es: 'Lista numerada'},
  'mail.tbQuote':      {it: 'Citazione', en: 'Quote', fr: 'Citation', de: 'Zitat', es: 'Cita'},
  'mail.tbLink':       {it: 'Inserisci link', en: 'Insert link', fr: 'Insérer un lien', de: 'Link einfügen', es: 'Insertar enlace'},
  'mail.tbClear':      {it: 'Rimuovi formattazione', en: 'Clear formatting', fr: 'Effacer la mise en forme', de: 'Formatierung entfernen', es: 'Borrar formato'},
  'mail.tbAttach':     {it: 'Allega file', en: 'Attach file', fr: 'Joindre un fichier', de: 'Datei anhängen', es: 'Adjuntar archivo'},
  'mail.tbSignature':  {it: 'Firma', en: 'Signature', fr: 'Signature', de: 'Signatur', es: 'Firma'},
  'mail.linkPrompt':   {it: 'Indirizzo del link (URL):', en: 'Link address (URL):', fr: 'Adresse du lien (URL) :', de: 'Link-Adresse (URL):', es: 'Dirección del enlace (URL):'},
  'mail.signatureTitle': {it: 'Firma email', en: 'Email signature', fr: 'Signature e-mail', de: 'E-Mail-Signatur', es: 'Firma de correo'},
  'mail.signatureHint': {it: 'Inserita automaticamente in fondo ai nuovi messaggi.', en: 'Automatically added at the bottom of new messages.', fr: 'Ajoutée automatiquement au bas des nouveaux messages.', de: 'Wird automatisch am Ende neuer Nachrichten eingefügt.', es: 'Se añade automáticamente al final de los mensajes nuevos.'},
  'mail.signatureSaved': {it: 'Firma salvata', en: 'Signature saved', fr: 'Signature enregistrée', de: 'Signatur gespeichert', es: 'Firma guardada'},
  'mail.newMessage':   {it: 'Nuovo messaggio', en: 'New message', fr: 'Nouveau message', de: 'Neue Nachricht', es: 'Mensaje nuevo'},
  'mail.maximize':     {it: 'Massimizza', en: 'Maximize', fr: 'Agrandir', de: 'Maximieren', es: 'Maximizar'},
  'mail.popout':       {it: 'Finestra separata', en: 'Pop out', fr: 'Fenêtre séparée', de: 'Separates Fenster', es: 'Ventana separada'},
  'mail.close':        {it: 'Chiudi', en: 'Close', fr: 'Fermer', de: 'Schließen', es: 'Cerrar'},
  'mail.draftSaved':   {it: 'Bozza salvata', en: 'Draft saved', fr: 'Brouillon enregistré', de: 'Entwurf gespeichert', es: 'Borrador guardado'},
  'mail.syncNow':      {it: 'Sincronizza ora', en: 'Sync now', fr: 'Synchroniser', de: 'Jetzt synchronisieren', es: 'Sincronizar ahora'},
  'mail.settings':     {it: 'Impostazioni', en: 'Settings', fr: 'Paramètres', de: 'Einstellungen', es: 'Ajustes'},
  'mail.settingsTitle': {it: 'Impostazioni email', en: 'Email settings', fr: 'Paramètres e-mail', de: 'E-Mail-Einstellungen', es: 'Ajustes de correo'},
  'mail.settingsSaved': {it: 'Impostazioni salvate', en: 'Settings saved', fr: 'Paramètres enregistrés', de: 'Einstellungen gespeichert', es: 'Ajustes guardados'},
  'mail.setMarkRead':  {it: "Segna come letto all'apertura", en: 'Mark as read on open', fr: "Marquer comme lu à l'ouverture", de: 'Beim Öffnen als gelesen markieren', es: 'Marcar como leído al abrir'},
  'mail.setAutosave':  {it: 'Salvataggio automatico in bozze', en: 'Autosave to drafts', fr: 'Enregistrement auto en brouillon', de: 'Automatisch als Entwurf speichern', es: 'Autoguardado en borradores'},
  'mail.setNewWindow': {it: 'Apri "Scrivi" in finestra separata', en: 'Open compose in a separate window', fr: 'Ouvrir la rédaction dans une fenêtre séparée', de: 'Verfassen in separatem Fenster öffnen', es: 'Abrir redacción en ventana separada'},
  'mail.setAutoRefresh': {it: 'Aggiornamento automatico', en: 'Auto refresh', fr: 'Actualisation auto', de: 'Automatische Aktualisierung', es: 'Actualización automática'},
  'mail.refreshOff':   {it: 'Disattivato', en: 'Off', fr: 'Désactivé', de: 'Aus', es: 'Desactivado'},
  'mail.setDefaultFont': {it: 'Font predefinito', en: 'Default font', fr: 'Police par défaut', de: 'Standardschriftart', es: 'Fuente predeterminada'},
  'mail.editSignature': {it: 'Modifica firma…', en: 'Edit signature…', fr: 'Modifier la signature…', de: 'Signatur bearbeiten…', es: 'Editar firma…'},
  'mail.sizeXS':       {it: 'Minuscolo', en: 'Tiny', fr: 'Minuscule', de: 'Winzig', es: 'Diminuto'},
  'mail.sizeS':        {it: 'Piccolo', en: 'Small', fr: 'Petit', de: 'Klein', es: 'Pequeño'},
  'mail.sizeM':        {it: 'Normale', en: 'Normal', fr: 'Normal', de: 'Normal', es: 'Normal'},
  'mail.sizeL':        {it: 'Medio', en: 'Medium', fr: 'Moyen', de: 'Mittel', es: 'Mediano'},
  'mail.sizeXL':       {it: 'Grande', en: 'Large', fr: 'Grand', de: 'Groß', es: 'Grande'},
  'mail.sizeXXL':      {it: 'Molto grande', en: 'Very large', fr: 'Très grand', de: 'Sehr groß', es: 'Muy grande'},
  'mail.sizeHuge':     {it: 'Enorme', en: 'Huge', fr: 'Énorme', de: 'Riesig', es: 'Enorme'},
  'mail.myLabels':     {it: 'Le mie etichette', en: 'My labels', fr: 'Mes libellés', de: 'Meine Labels', es: 'Mis etiquetas'},
  'mail.newLabel':     {it: 'Nuova etichetta', en: 'New label', fr: 'Nouveau libellé', de: 'Neues Label', es: 'Nueva etiqueta'},
  'mail.labelName':    {it: 'Nome etichetta', en: 'Label name', fr: 'Nom du libellé', de: 'Label-Name', es: 'Nombre de etiqueta'},
  'mail.labelParent':  {it: 'Annida sotto', en: 'Nest under', fr: 'Imbriquer sous', de: 'Verschachteln unter', es: 'Anidar bajo'},
  'mail.noParent':     {it: '(nessuno)', en: '(none)', fr: '(aucun)', de: '(keine)', es: '(ninguno)'},
  'mail.create':       {it: 'Crea', en: 'Create', fr: 'Créer', de: 'Erstellen', es: 'Crear'},
  'mail.renameLabel':  {it: 'Rinomina', en: 'Rename', fr: 'Renommer', de: 'Umbenennen', es: 'Renombrar'},
  'mail.deleteLabel':  {it: 'Elimina etichetta', en: 'Delete label', fr: 'Supprimer le libellé', de: 'Label löschen', es: 'Eliminar etiqueta'},
  'mail.renamePrompt': {it: 'Nuovo nome (usa "/" per annidare):', en: 'New name (use "/" to nest):', fr: 'Nouveau nom (utilisez "/" pour imbriquer) :', de: 'Neuer Name ("/" zum Verschachteln):', es: 'Nuevo nombre (usa "/" para anidar):'},
  'mail.deleteLabelConfirm': {it: 'Eliminare l\'etichetta "{name}"? Le email non vengono cancellate.', en: 'Delete label "{name}"? Emails are not deleted.', fr: 'Supprimer le libellé « {name} » ? Les e-mails ne sont pas supprimés.', de: 'Label „{name}" löschen? E-Mails werden nicht gelöscht.', es: '¿Eliminar la etiqueta "{name}"? Los correos no se eliminan.'},
  'mail.labelCreated': {it: 'Etichetta creata', en: 'Label created', fr: 'Libellé créé', de: 'Label erstellt', es: 'Etiqueta creada'},
  'mail.labelRenamed': {it: 'Etichetta rinominata', en: 'Label renamed', fr: 'Libellé renommé', de: 'Label umbenannt', es: 'Etiqueta renombrada'},
  'mail.labelDeleted': {it: 'Etichetta eliminata', en: 'Label deleted', fr: 'Libellé supprimé', de: 'Label gelöscht', es: 'Etiqueta eliminada'},
  'mail.advSearch':    {it: 'Ricerca avanzata', en: 'Advanced search', fr: 'Recherche avancée', de: 'Erweiterte Suche', es: 'Búsqueda avanzada'},
  'mail.advFrom':      {it: 'Da', en: 'From', fr: 'De', de: 'Von', es: 'De'},
  'mail.advTo':        {it: 'A', en: 'To', fr: 'À', de: 'An', es: 'Para'},
  'mail.advSubject':   {it: 'Oggetto', en: 'Subject', fr: 'Objet', de: 'Betreff', es: 'Asunto'},
  'mail.advWords':     {it: 'Contiene le parole', en: 'Has the words', fr: 'Contient les mots', de: 'Enthält die Wörter', es: 'Contiene las palabras'},
  'mail.advAfter':     {it: 'Dopo', en: 'After', fr: 'Après', de: 'Nach', es: 'Después'},
  'mail.advBefore':    {it: 'Prima', en: 'Before', fr: 'Avant', de: 'Vor', es: 'Antes'},
  'mail.advHasAttach': {it: 'Con allegati', en: 'Has attachment', fr: 'Avec pièce jointe', de: 'Mit Anhang', es: 'Con adjunto'},
  'mail.advRun':       {it: 'Cerca', en: 'Search', fr: 'Rechercher', de: 'Suchen', es: 'Buscar'},
  'mail.tabGeneral':   {it: 'Generali', en: 'General', fr: 'Général', de: 'Allgemein', es: 'General'},
  'mail.tabContacts':  {it: 'Rubrica', en: 'Contacts', fr: 'Contacts', de: 'Kontakte', es: 'Contactos'},
  'mail.tabFilters':   {it: 'Filtri', en: 'Filters', fr: 'Filtres', de: 'Filter', es: 'Filtros'},
  'mail.tabVacation':  {it: 'Risposta automatica', en: 'Auto-reply', fr: 'Réponse auto', de: 'Autoantwort', es: 'Respuesta automática'},
  'mail.contactsSearch': {it: 'Cerca contatto…', en: 'Search contact…', fr: 'Rechercher un contact…', de: 'Kontakt suchen…', es: 'Buscar contacto…'},
  'mail.contactsEmpty': {it: 'Nessun contatto', en: 'No contacts', fr: 'Aucun contact', de: 'Keine Kontakte', es: 'Sin contactos'},
  'mail.write':        {it: 'Scrivi', en: 'Compose', fr: 'Écrire', de: 'Schreiben', es: 'Escribir'},
  'mail.filtHasWords': {it: 'Contiene', en: 'Contains', fr: 'Contient', de: 'Enthält', es: 'Contiene'},
  'mail.filtThen':     {it: 'Poi:', en: 'Then:', fr: 'Puis :', de: 'Dann:', es: 'Luego:'},
  'mail.filtApplyLabel': {it: 'Applica etichetta', en: 'Apply label', fr: 'Appliquer le libellé', de: 'Label anwenden', es: 'Aplicar etiqueta'},
  'mail.filtCreate':   {it: 'Crea filtro', en: 'Create filter', fr: 'Créer le filtre', de: 'Filter erstellen', es: 'Crear filtro'},
  'mail.filtCreated':  {it: 'Filtro creato', en: 'Filter created', fr: 'Filtre créé', de: 'Filter erstellt', es: 'Filtro creado'},
  'mail.filtInvalid':  {it: 'Serve almeno un criterio e un\'azione', en: 'Need at least one criterion and one action', fr: 'Au moins un critère et une action', de: 'Mindestens ein Kriterium und eine Aktion', es: 'Se necesita al menos un criterio y una acción'},
  'mail.filtEmpty':    {it: 'Nessun filtro', en: 'No filters', fr: 'Aucun filtre', de: 'Keine Filter', es: 'Sin filtros'},
  'mail.filtDelConfirm': {it: 'Eliminare questo filtro?', en: 'Delete this filter?', fr: 'Supprimer ce filtre ?', de: 'Diesen Filter löschen?', es: '¿Eliminar este filtro?'},
  'mail.filtDeleted':  {it: 'Filtro eliminato', en: 'Filter deleted', fr: 'Filtre supprimé', de: 'Filter gelöscht', es: 'Filtro eliminado'},
  'mail.vacEnable':    {it: 'Attiva risposta automatica', en: 'Enable auto-reply', fr: 'Activer la réponse auto', de: 'Autoantwort aktivieren', es: 'Activar respuesta automática'},
  'mail.vacSubject':   {it: 'Oggetto risposta', en: 'Reply subject', fr: 'Objet de la réponse', de: 'Antwort-Betreff', es: 'Asunto de respuesta'},
  'mail.vacRestrict':  {it: 'Solo ai miei contatti', en: 'Only to my contacts', fr: 'Uniquement à mes contacts', de: 'Nur an meine Kontakte', es: 'Solo a mis contactos'},
  'mail.vacSaved':     {it: 'Risposta automatica salvata', en: 'Auto-reply saved', fr: 'Réponse auto enregistrée', de: 'Autoantwort gespeichert', es: 'Respuesta automática guardada'},
  'mail.aiReply':      {it: 'Rispondi con AI', en: 'Reply with AI', fr: 'Répondre avec IA', de: 'Mit KI antworten', es: 'Responder con IA'},
  'mail.aiExtract':    {it: 'Estrai', en: 'Extract', fr: 'Extraire', de: 'Extrahieren', es: 'Extraer'},
  'mail.aiReplyPrompt': {it: 'Istruzioni per la risposta (opzionale — es. "conferma disponibilità", "chiedi preventivo"):', en: 'Reply instructions (optional — e.g. "confirm availability", "ask for a quote"):', fr: 'Instructions de réponse (optionnel — ex. « confirmer la disponibilité ») :', de: 'Antwort-Anweisungen (optional — z. B. „Verfügbarkeit bestätigen"):', es: 'Instrucciones de respuesta (opcional — p. ej. "confirmar disponibilidad"):'},
  'mail.aiSearch':     {it: 'Ricerca AI', en: 'AI search', fr: 'Recherche IA', de: 'KI-Suche', es: 'Búsqueda IA'},
  'mail.aiSearchPrompt': {it: 'Cosa cerchi? (es. "email di Anna con allegati sul progetto A24 di luglio")', en: 'What are you looking for? (e.g. "emails from Anna with attachments about project A24 in July")', fr: 'Que cherchez-vous ? (ex. « e-mails d\'Anna avec pièces jointes sur le projet A24 »)', de: 'Wonach suchst du? (z. B. „E-Mails von Anna mit Anhängen zu Projekt A24")', es: '¿Qué buscas? (p. ej. "correos de Anna con adjuntos sobre el proyecto A24")'},
  'mail.aiThinking':   {it: 'AI al lavoro…', en: 'AI working…', fr: 'IA en cours…', de: 'KI arbeitet…', es: 'IA trabajando…'},
  'mail.aiNoProvider': {it: 'Nessun provider AI configurato (Impostazioni → AI)', en: 'No AI provider configured (Settings → AI)', fr: 'Aucun fournisseur IA configuré (Paramètres → IA)', de: 'Kein KI-Anbieter konfiguriert (Einstellungen → KI)', es: 'Sin proveedor de IA configurado (Ajustes → IA)'},
  'mail.aiNoCopilot':  {it: 'Copilot non disponibile in questa vista', en: 'Copilot not available in this view', fr: 'Copilote indisponible dans cette vue', de: 'Copilot in dieser Ansicht nicht verfügbar', es: 'Copiloto no disponible en esta vista'},
  'mail.aiError':      {it: 'Errore AI', en: 'AI error', fr: 'Erreur IA', de: 'KI-Fehler', es: 'Error de IA'},
  ...
  'contact.notes':       {it: 'Note', en: 'Notes', fr: 'Notes', de: 'Notizen', es: 'Notas'},
  'contact.sectionIdentity': {it: 'Anagrafica', en: 'Identity', fr: 'Identité', de: 'Stammdaten', es: 'Datos personales'},
  'contact.sectionCompany':  {it: 'Azienda e ruolo', en: 'Company & role', fr: 'Entreprise et rôle', de: 'Firma und Rolle', es: 'Empresa y rol'},
  'contact.sectionContacts': {it: 'Contatti', en: 'Contact info', fr: 'Coordonnées', de: 'Kontaktdaten', es: 'Datos de contacto'},
