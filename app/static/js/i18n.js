...
window.MF_I18N = {
  ...
  'copilot.web.instruction':            {it: 'Cerca sul web informazioni sul cliente e sul progetto correnti usando le fonti configurate, poi proponi gli aggiornamenti.', en: 'Search the web for information about the current client and project using the configured sources, then propose updates.', fr: 'Recherche sur le web des informations sur le client et le projet actuels en utilisant les sources configurées, puis propose des mises à jour.', de: 'Suche im Web nach Informationen über den aktuellen Kunden und das aktuelle Projekt mithilfe der konfigurierten Quellen und schlage dann Aktualisierierungen vor.', es: 'Busca en la web información sobre el cliente y el proyecto actuales usando las fuentes configuradas, luego propón actualizaciones.'},
