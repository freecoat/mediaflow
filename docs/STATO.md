...
- **Default tenant** editabile in `/settings` → tab "Naming asset", per disciplina **video** e **audio**, seedato dalle convenzioni industry (DCP ISDCF / IMF / Netflix), **lazy** (costante finché non si salva).
